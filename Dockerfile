...
CMD /opt/infinispan/bin/standalone.sh --server-config=clustered.xml -Djboss.default.jgroups.stack=tcp-gossip -Djgroups.gossip.initial_hosts=$router_server_list -Djboss.bind.address=$bind_ip 
